...
- **Direct % TBSA Entry & Two-Way Sync:** Rapid direct numerical input for bedside-calculated % TBSA enabling immediate fluid rate calculation without requiring body mapping.
