...
- **Collapsible Module Architecture & High-Contrast Theme Headers:** All 5 core clinical sections are designed as collapsible accordions (collapsed by default for clean cognitive load) with high-contrast, theme-colored headers (Amber/Flame for Fluid, Clinical Blue for Airway, Royal Purple for Toxicology, Crimson Red for Escharotomy/ABA, Forest Green for Painter), plus global "➕ ขยายทั้งหมด" / "➖ ยุบทั้งหมด" controls.
...
- **Direct % TBSA Entry & Sticky Summary Banner:** Prominent full-width summary banner with severity color shifts (amber/orange/red), direct numerical % TBSA input, quick-scroll link to the BSA painter, and automated ABA referral syncing.
