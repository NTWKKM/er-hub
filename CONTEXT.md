...
- **Decision:**
  ...
  7. **Print changes:** Stat Medications block uses `.order-list-plain` (no bullets). Prasugrel print `<li>` uses normal text color (not red). Ticagrelor continuation wording → `1 x 2 pc`. Blank-print manifest entries synced.
