...
Features:
- **Interactive 6-Column Lund & Browder Body Mapper:** Interactive SVG human body model (Anterior & Posterior) supporting 6 age brackets (`0`: <1y, `1`: 1–4y, `5`: 5–9y, `10`: 10–14y, `15`: 15–17y, `adult`: ≥18y) with fine-grained sub-regional painting (Chest, Abdomen, Upper/Lower Back, Upper/Lower Arms, Hands, Thighs, Lower Legs, Feet) and real-time depth color-coding (1st, 2nd, 3rd/4th degree).
- **Direct % TBSA Entry & Two-Way Sync:** Rapid direct numerical input for bedside-calculated % TBSA enabling immediate fluid rate calculation without requiring body mapping, with automated ABA referral syncing.
