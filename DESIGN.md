...
| **Patient Sticker Box** | Standardized dashed bounding box mimicking paper patient label stickers. | Screen: `width: 170px; height: 46px;` Print: `width: 48mm; height: 12mm;` |
...
- **Sticker Box:** Print dimensions `48mm × 12mm` (compact, calibrated for strict 1-page A4 print fit). Screen size `170px × 46px`.
