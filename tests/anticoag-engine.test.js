...
// calcAnticoag and calcEGFR_CKDEPI2021 were removed from anticoag-engine.js
// (eGFR now lives solely in clinical-engine.js; calcAnticoag was never called
// by any order page). Their tests were removed to match.
const { calcHeparinInitialDose, getHeparinTitration, HEPARIN_STANDALONE_PROTOCOLS } = require('../shared/anticoag-engine.js');
