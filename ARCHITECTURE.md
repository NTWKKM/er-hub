...
|---|---|---|
| `Hub (index.html)` | Application portal listing all ER Standing Orders and calculators. Compact name-only cards with direct print-blank buttons. Direct entry point. | None |
