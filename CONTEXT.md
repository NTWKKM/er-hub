...
- **Update (2026-07-01):** Card descriptions (`<p class="card-desc">`) were retained on portal cards despite ADR-05's original "remove all card descriptions" decision. Descriptions provide brief Thai-language context for each protocol and improve scannability for ER staff who may not recognize every protocol by name alone. This supersedes the removal portion of ADR-05. The rest of ADR-05 (remove status badges, compact padding) remains in effect.
